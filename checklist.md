...
- [ ] v1.1 온라인 배포 및 가독성 개선 작업
  - [ ] PC 대시보드 index.html 폰트 크기 스케일업
  - [ ] 모바일 앱 컴포넌트 및 화면(Feed, Detail, Auth, Favorites) 가독성 스케일업
  - [ ] Firebase Hosting 설정 및 Expo Web 빌드 경로(/mobile) 맵핑
  - [ ] Firebase Hosting 통합 온라인 배포 완수
